...
class DeliveryReportModel {
  ...
  final bool status;
  final List<DeliveryReportDataModel> data;
  ...
  factory DeliveryReportModel.fromJson(Map<String, dynamic> json) {
    return DeliveryReportModel(
      ...
      data: json["data"] == null
          ? []
          : List<DeliveryReportDataModel>.from(
          json["data"]!.map((x) => DeliveryReportDataModel.fromJson(x))),
    );
  }
...
class DeliveryReportDataModel {
  DeliveryReportDataModel({
    required this.vNo,
    required this.vDate,
    required this.vTime,
    required this.vMiti,
  ...
  factory DeliveryReportDataModel.fromJson(Map<String, dynamic> json) {
    return DeliveryReportDataModel(
      vNo: json["VNo"] ?? "",
      vDate: json["VDate"] ?? "",
      vTime: json["VTime"] ?? "",
      vMiti: json["VMiti"] ?? "",
