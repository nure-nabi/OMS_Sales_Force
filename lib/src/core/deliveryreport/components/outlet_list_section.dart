...
class DeliveryOutletSection extends StatelessWidget {
  const DeliveryOutletSection({super.key});

  @override
  Widget build(BuildContext context) {
    final state = context.watch<DeliveryState>();
    return Scaffold(
  ...
  Widget _buildList(DeliveryReportDataModel indexData) {
    return Padding(
