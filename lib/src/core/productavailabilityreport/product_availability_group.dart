...
class ProductAvailabilityGroupScreen extends StatefulWidget {

  const ProductAvailabilityGroupScreen({super.key,});

  @override
  State<ProductAvailabilityGroupScreen> createState() => _ProductAvailabilityGroupScreenState();
}

class _ProductAvailabilityGroupScreenState extends State<ProductAvailabilityGroupScreen> {
  @override
  void initState() {
    super.initState();
    outletNameShow();
                      ...
                      return Container(
                        ...
                        child: InkWell(
                          onTap: () async {
                            ...
                            await state.groupSelectedAvailabality();
                          },
                          child: Padding(
