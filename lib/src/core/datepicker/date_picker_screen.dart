...
class DatePickerWidget extends StatefulWidget {
  ...
  final bool isNepaliPicker;
  const DatePickerWidget({
    super.key,
    required this.onConfirm,
    this.isNepaliPicker = false,
  });
                ...
                child: Row(
                  ...
                  children: [
                    Expanded(
                      child: InkWell(
                        onTap: () async {
                          state.getFromDate = widget.isNepaliPicker
                              ? await MyDatePicker(context).nepaliDate()
                    ...
                    Expanded(
                        child: InkWell(
                      onTap: () async {
                        state.getToDate = widget.isNepaliPicker
                            ? await MyDatePicker(context).nepaliDate()
                            : await MyDatePicker(context).englishDate();
                      },
                      child: Container(
